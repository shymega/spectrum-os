{
  ...
  jekyll-asciidoc = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "13yjmz88sayq43pf8vdw786092zn5h686i39b3bxhfyw6vppwnb3";
      type = "gem";
    };
    version = "3.0.0";
  };
  ...
  just-the-docs = {
    dependencies = ["jekyll" "jekyll-seo-tag" "rake"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0ii5jcpqnmqc1yx37yv0xrf1jbg2ab8xj0fvc5p3mjg2hlwgxg39";
      type = "gem";
    };
    version = "0.4.0.rc3";
  };
